...
<div class="create-container">
    <div class="inner-create-container">
        <div class="create-box">
            <form @submit.prevent="addPoint" method="post">
                <h2>Create Point Of Interest</h2>
                <div class="dash"></div>
                <input v-model="point.title" id="title" type="text" placeholder="Title" onfocus="placeholder=''" onblur="placeholder='Title'" required>
...
export default {
    name: 'CreatePointOfInterestComp',
    data() {
        return {
            point: {
                title: '',
